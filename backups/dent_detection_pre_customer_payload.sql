...
CREATE TABLE public.inspections (
    ...
    vehicle_registration character varying(30),
    vehicle_make character varying(60),
    vehicle_model character varying(60),
    vehicle_year integer,
    vehicle_colour character varying(40),
...
--
-- Name: ix_inspections_vehicle_registration; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX ix_inspections_vehicle_registration ON public.inspections USING btree (vehicle_registration);
